...
public class kacangcoklat extends AppCompatActivity {
    int quantity = 30000;
    String jenis="Jagung Keju";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kacangcoklat);

        TextView quantityTextView = (TextView) findViewById(R.id.harga_kacangcoklat);
        quantityTextView.setText("Rp. "+quantity);

        String text = "Martabak jagung keju merupakan salah satu cemilan yang bisa mengganjal perut " +
                ...
                "Rasa manis dari jagung meises ditambahnya gurihnya keju berpadu denga lembutnya kulit martabak, " +
