...
public class jagungkeju extends AppCompatActivity {
    int quantity = 30000;
    String jenis="Jagung Keju";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jagungkeju);

        TextView quantityTextView = (TextView) findViewById(R.id.harga_jagungkeju);
        ...
        String text = "Martabak jagung keju merupakan salah satu cemilan yang bisa mengganjal perut " +
                ...
                "Rasa manis dari jagung ditambahnya gurihnya keju berpadu denga lembutnya kulit martabak, " +
