...
int quantity = 30000;
    String jenis="Kacang Coklat";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_durian);

        TextView quantityTextView = (TextView) findViewById(R.id.harga_durian);
        quantityTextView.setText("Rp. "+quantity);

        String text = "Martabak durian merupakan salah satu cemilan yang bisa mengganjal perut " +
                ...
                "Rasa manis ditambahnya gurihnya durian berpadu dengan lembutnya kulit martabak, " +
