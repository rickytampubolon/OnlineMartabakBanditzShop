...
public class jagung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView quantityTextView = (TextView) findViewById(R.id.harga_jagung);
        quantityTextView.setText("Rp. "+quantity);

        String text = "Martabak jagung merupakan salah satu cemilan yang bisa mengganjal perut " +
                ...
                "Rasa manis ditambahnya gurihnya jagung berpadu denga lembutnya kulit martabak, " +
