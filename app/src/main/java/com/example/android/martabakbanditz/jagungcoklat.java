...
public class jagungcoklat extends AppCompatActivity {
    int quantity = 30000;
    String jenis="Jagung Coklat";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jagungcoklat);

        TextView quantityTextView = (TextView) findViewById(R.id.harga_jagungcoklat);
        quantityTextView.setText("Rp. "+quantity);

        String text = "Martabak kacang coklat merupakan salah satu cemilan yang bisa mengganjal perut " +
                ...
                "Rasa manis dari coklat meises ditambahnya gurihnya kacang berpadu denga lembutnya kulit martabak, " +
