...
public class keju extends AppCompatActivity {
    int quantity = 30000;
    String jenis="Keju";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView quantityTextView = (TextView) findViewById(R.id.harga_keju);
        quantityTextView.setText("Rp. "+quantity);

        String text = "Martabak keju merupakan salah satu cemilan yang bisa mengganjal perut " +
                ...
                "Rasa asin ditambahnya gurihnya keju berpadu denga lembutnya kulit martabak, " +
